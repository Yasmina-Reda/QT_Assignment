...
public:
    ...
    void setupUi(QDialog *Order)
    {
        ...
        label_showNumItems->setObjectName(QString::fromUtf8("label_showNumItems"));
        label_showNumItems->setGeometry(QRect(300, 310, 61, 16));
        label_showPrice = new QLabel(Order);
        label_showPrice->setObjectName(QString::fromUtf8("label_showPrice"));
        label_showPrice->setGeometry(QRect(230, 260, 61, 31));
        pushButton_addCart = new QPushButton(Order);
        pushButton_addCart->setObjectName(QString::fromUtf8("pushButton_addCart"));
        pushButton_addCart->setGeometry(QRect(380, 270, 171, 41));
        pushButton_viewCart = new QPushButton(Order);
        pushButton_viewCart->setObjectName(QString::fromUtf8("pushButton_viewCart"));
        ...
        label_balance_order->setObjectName(QString::fromUtf8("label_balance_order"));
        label_balance_order->setGeometry(QRect(170, 420, 81, 16));
        label_Currency_order = new QLabel(Order);
        label_Currency_order->setObjectName(QString::fromUtf8("label_Currency_order"));
        label_Currency_order->setGeometry(QRect(390, 420, 41, 16));
        label_numItems = new QLabel(Order);
        label_numItems->setObjectName(QString::fromUtf8("label_numItems"));
        ...
        meat->addItem(QString());
        meat->addItem(QString());
        meat->setObjectName(QString::fromUtf8("meat"));
        ...
        sideoptions->addItem(QString());
        sideoptions->addItem(QString());
        sideoptions->setObjectName(QString::fromUtf8("sideoptions"));
